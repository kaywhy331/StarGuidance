...
1. Open the exact Deploy Preview #4 URL in a fresh private browser window and confirm `/api/health` reports liveness and the expected commit. Confirm deep staging readiness from the protected workflow summary, not from the public endpoint.
