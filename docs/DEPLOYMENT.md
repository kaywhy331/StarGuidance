...
7. Durable report generation, retry/status handling, structured web output, and browser print/PDF are implemented. Keep profile reports disabled until Stripe test UAT, hosted failure/recovery rehearsal, standalone purchased-report history/support diagnostics, and an accessible generated-PDF parity gate pass.
